                    ...
                    >
                        ...
                        <td class="px-6 py-4">
                            <div class="flex justify-center gap-3">
                                <button
                                    class="px-4 py-1.5 text-sm font-medium text-white bg-blue-500 rounded-lg hover:bg-blue-700 transition-all border border-blue-100"
                                >
                                    Edit
                                </button>
                                <button
                                    class="px-4 py-1.5 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-800 transition-all border border-red-100"
                                >
                                    Delete
                                </button>
                            </div>
